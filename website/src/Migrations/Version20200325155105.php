 ...
 */
final class Version20200325155105 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE command_product CHANGE command_id command_id INT DEFAULT NULL, CHANGE cart_product_id cart_product_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE users CHANGE cart_id cart_id INT DEFAULT NULL, CHANGE budget budget FLOAT DEFAULT NULL');
        $this->addSql('ALTER TABLE command ADD total DOUBLE PRECISION DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE nb_command nb_command INT DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cart_product CHANGE product_id product_id INT DEFAULT NULL, CHANGE flocage_id flocage_id INT DEFAULT NULL, CHANGE size_id size_id INT DEFAULT NULL, CHANGE cart_id cart_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE quantity quantity INT DEFAULT NULL');
        $this->addSql('ALTER TABLE command DROP total, CHANGE user_id user_id INT DEFAULT NULL, CHANGE nb_command nb_command INT DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE command_product CHANGE command_id command_id INT DEFAULT NULL, CHANGE cart_product_id cart_product_id INT DEFAULT NULL');
