...
final class Version20200407123818 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE commands (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, nb_command INT DEFAULT NULL, total FLOAT DEFAULT NULL, created_at DATETIME DEFAULT NULL, INDEX IDX_8ECAEAD4A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE commands ADD CONSTRAINT FK_8ECAEAD4A76ED395 FOREIGN KEY (user_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE command_cart_product ADD CONSTRAINT FK_2FA703C33E1689A FOREIGN KEY (command_id) REFERENCES commands (id) ON DELETE CASCADE');
