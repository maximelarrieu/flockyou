...
final class Version20200205162353 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE bank (id INT AUTO_INCREMENT NOT NULL, cart_number VARCHAR(255) DEFAULT NULL, expiration_date DATE DEFAULT NULL, cart_code INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
